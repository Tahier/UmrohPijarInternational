	...
	<?= link_tag('css/datetimepicker/css/bootstrap-datetimepicker.css') ?>
		...
		<body>
			<div class="container">
				...
				<?php echo form_open('agen_controller/add_paket'); ?>

				<label for="paket_nomor">Nomor Paket : </label>
				<input type="text" name="paket_nomor" value="<?= $nomor; ?>" readonly />

				<br/ >

				<label for="paket_nama">Nama Paket : </label>
				<input type="text" name="paket_nama" required/>

				<br/ >				

				<label for="paket_harga">Harga Paket : </label>
				<input type="text" name="paket_harga" required/> USD

				<br/ >

				<label for="paket_deskripsi"> Paket Deskripsi : </label>
				<textarea name="paket_deskripsi"></textarea>

				<br/ >

				<label for="paket_mekah">Paket Mekah : </label>
				<textarea name="paket_mekah"></textarea>

				<br/ >

				<label for="paket_madinah">Paket Madinah : </label>
				<textarea name="paket_madinah"></textarea>
				...
				<label for="paket_tanggal_berangkat">Tanggal Berangkat : </label>
				 ...
				 <div class="input-group date form_datetime col-md-5" data-date="" data-date-format="yyyy-mm-dd HH:ii:ss" data-link-field="dtp_input1">
                    <input class="form-control" size="16" type="text" required value="" name="paket_tgl_berangkat" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
					<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                </div>
				<label for="paket_tanggal_pulang">Tanggal Pulang : </label>
				 <div class="input-group date form_datetime col-md-5" data-date="" data-date-format="yyyy-mm-dd HH:ii:ss" data-link-field="dtp_input1">
                    <input class="form-control" size="16" type="text" required value="" name="paket_tgl_pulang" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
					<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                </div>
